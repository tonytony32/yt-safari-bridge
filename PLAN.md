...
3. Verify the generated project builds: `xcodebuild -project YTBridge/YTBridge.xcodeproj -scheme YTBridge build` (sign with your personal team for persistence, or use Safari's "Allow Unsigned Extensions" each session).
